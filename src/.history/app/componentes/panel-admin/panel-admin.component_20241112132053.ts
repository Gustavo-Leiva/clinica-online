...
export class PanelAdminComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log("flagAdmin: ", this.flagAdmin);
    console.log("mostrarUsuarios: ", this.mostrarUsuarios);
    console.log("mostrarAceptarEspecialistas: ", this.mostrarAceptarEspecialistas);
    console.log("mostrarRegistrarUsuarios: ", this.mostrarRegistrarUsuarios);
    console.log("mostrarTurnos: ", this.mostrarTurnos);
    }
